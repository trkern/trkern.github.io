...
/*
tk: the line above was modified to allow escaping \ for newline (dollar sign along for the ride)
*/
      else {
...
LatexCmds["\\"] = bind(VanillaSymbol, '\\\\', "<br/><span>&#8203;</span>");
...
var Toity = P(BinaryOperator, function(_, super_) {
  _.init = function() {
    super_.init.call(this, '\\to ', '&rarr;');
  };
  _.createLeftOf = function(cursor) {
    super_.createLeftOf.apply(this, arguments);
  };
...
var LimitNotation = P(MathCommand, function(_, super_) {
  _.init = function(ch, html) {
    var htmlTemplate =
      '<span class="mq-large-operator mq-non-leaf" style="margin-right:.5em">'
    +   '<big>'+html+'</big>'
    +   '<span class="mq-from"><span>&0</span></span>'
    + '</span>';
    Symbol.prototype.init.call(this, ch, htmlTemplate);
...
LatexCmds.lim =
LatexCmds.limit = bind(LimitNotation,'\\lim ','lim');
